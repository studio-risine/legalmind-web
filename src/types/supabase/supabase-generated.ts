  ...
  public: {
    Tables: {
      ...
      clients: {
        ...
        Relationships: [
          {
            foreignKeyName: "clients_space_id_fkey"
            columns: ["space_id"]
            isOneToOne: false
      ...
      processes: {
        ...
        Relationships: [
          {
            foreignKeyName: "processes_assigned_lawyer_id_fkey"
          ...
          {
            foreignKeyName: "processes_space_id_fkey"
            columns: ["space_id"]
            isOneToOne: false
            referencedRelation: "spaces"
            referencedColumns: ["id"]
      ...
      profile_spaces: {
        ...
        Relationships: [
          {
            foreignKeyName: "profile_spaces_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "profile_spaces_space_id_fkey"
            columns: ["space_id"]
            isOneToOne: false
            referencedRelation: "spaces"
            referencedColumns: ["id"]
    ...
    Enums: {
      ...
      UserRoleType: "ADMIN" | "LAWYER" | "CLIENT"
    }
    CompositeTypes: {
      [_ in never]: never
    }
