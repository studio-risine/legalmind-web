...
ALTER TABLE "core"."spaces_to_accounts" ADD CONSTRAINT "spaces_to_accounts_account_id_accounts_user_id_fk" FOREIGN KEY ("account_id") REFERENCES "core"."accounts"("user_id") ON DELETE cascade ON UPDATE no action;